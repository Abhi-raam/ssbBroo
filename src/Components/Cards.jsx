...
function Cards() {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 p-5 px-4 lg:px-16 mx-auto pt-16'>
        <div className='bg-sky-100 p-6 space-y-4 flex flex-col rounded-md items-center justify-center hover:bg-sky-500 hover:text-white hover:-translate-y-6 transition delay-100 duration-500 ease-in-out'>
